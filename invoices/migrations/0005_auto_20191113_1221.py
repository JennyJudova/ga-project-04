...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('invoices', '0004_auto_20191113_1138'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity_hrs', models.FloatField(default=0, null=True)),
                ('unit_price_hrs', models.FloatField(default=0, null=True)),
                ...
                ('total', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='GBP', max_digits=10, null=True)),
            ],
        ),
        migrations.AddField(
            model_name='invoice',
            name='client',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='invoice', to='invoices.Client'),
        ),
        migrations.AddField(
            model_name='invoice',
            name='invoice_items',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='invoice', to='invoices.Invoice_Item'),
        ),
    ]
