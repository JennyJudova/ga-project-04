...
#     creator = NestedUserSerializer(required=False)
...
class PopulatedInvoiceSerializer(InvoiceSerializer): # again same idea as with the populated comment serilaizer, it inherits from Post Serializer and gets all the meta class and fields from that
